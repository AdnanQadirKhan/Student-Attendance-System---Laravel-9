        ...
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="title mb-30">
                            <h2> <i class="fa-solid fa-user me-2"></i> System Report Section</h2>
                        </div>
                    </div>
                    <!-- end col -->
                    <div class="col-md-6 ">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="systemReportForm" class="d-flex mb-5">
                        @csrf
                        <span class="input-group-text">From</span>
                        <input type="date" name="from" id="from" class="form-control-sm col-4 me-3">
                        <span class="input-group-text">To</span>
                        <input type="date" name="to" id="to" class="form-control-sm col-4 me-5">
                        <button type="button" id="reportBtn" class="btn btn-primary">Generate</button>
                    </form>
